...
checkbox_toggle_label('woocommerce');
...
function oribi_options_page_html() {
    ...
    <div id="oribi-wrap">
        ...
        <div>
            <h2><?php esc_html_e( 'Oribi Analytics', 'oribi' ); ?></h2>
            ...
            <form method="post" action="options.php">
                ...
                <div id="oribi-form-checkbox">
                    ...
                    <label class="switch" for="oribi-woocommerce-checkbox">
                        <input type="checkbox" id="oribi-woocommerce-checkbox" name="oribi_tracking_capabilities[woocommerce]" value="1" <?php checked( 1 == $tracking_capabilities[ 'woocommerce' ] ); ?> />
                        <span class="slider round"></span>
                    </label>
                    <p class="oribi-switch-title oribi-woocommerce-checkbox-title">WooCommerce integration feature is
                        <span class="oribi-woocommerce-status-on oribi-medium-font" style="display: <?php echo ( 1 == $tracking_capabilities[ 'woocommerce' ] ? 'initial' : 'none' ); ?>">connected</span>
                        <span class="oribi-woocommerce-status-off oribi-medium-font" style="display: <?php echo ( 0 == $tracking_capabilities[ 'woocommerce' ] ? 'initial' : 'none' ); ?>">disconnected</span>
                    </p>
                    <p class="oribi-switch-description">Oribi’s WooCommerce integration feature allows you to track WooCommerce purchases.</p>
                </div>
                <div id="oribi-form-checkbox">
