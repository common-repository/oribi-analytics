...
class Oribi_Event_Tracker {
    ...
    public static function init() {
        ...
        if ( isset( $tracking_capabilities['woocommerce'] ) && (bool)$tracking_capabilities['woocommerce'] ) {
    ...
    public static function oribiDisplayUserSetting() {
        ...
        return '.' . ($tracking_capabilities['completed'] ? '1' : '0') . '.' . ($tracking_capabilities['email'] ? '1' : '0') . '.' . ($tracking_capabilities['woocommerce'] ? '1' : '0');
    }
    ...
    public static function oribi_track_woocommerce_purchase( $result, $order_id ) {
        ...
        foreach( $items as $item ) {
            ...
            $price = (float)round($item->get_subtotal() / $quantity, 2);
            ...
            $product = array(
                ...
                'name'          => $item->get_name(),
                'price'         => $price,
                'taxPrice'      => (float)round($item->get_subtotal_tax() / $quantity, 2),
